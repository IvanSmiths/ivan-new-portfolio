...
const Blog: FC = async () => {
  ...
  return (
    <div className="grid md:m-0 mb-section">
      ...
      <div className="md:col-start-4 md:col-end-13 col-span-full flex flex-col gap-regular">
          ...
          <>
            ...
            >
              <div className="flex md:gap-medium gap-small items-center">
                <span className="lato">0{index + 1}</span>
                <h3 className="font-semibold md:text-3xl text-xl text-left">
                  {post?.title}
                </h3>
              </div>
              <div className="sm:flex ml-regular flex-col gap-smallest min-w-fit hidden text-right">
                ...
                <span className="lato">{post?.time} min to read</span>
              </div>
            </Link>
