...
export default function MenuButton({ isOpen, toggleMenu }: MenuButtonProps) {
  return (
    <button
      onClick={toggleMenu}
      className="visible fixed bottom-small right-small z-30 flex h-14 w-14 flex-col items-center justify-center gap-1 rounded-full bg-dark p-3.5 transition dark:bg-light md:hidden"
