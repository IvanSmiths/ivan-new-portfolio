...
excerpt: Learn how to add Google Analytics to your Next.js App Router project without relying on third-party libraries. This guide walks you through the setup using native Next.js features for a leaner, dependency-free implementation.
date: 2025-05-26T12:00:00+08:00
slug: how-to-add-google-analytics-to-next-js-without-third-party-package
category: Guide
cover: https://res.cloudinary.com/deino2cjx/image/upload/v1748246277/portfolio/blog/Next%20Google%20Analytics/cover_iplg3d.png
coverAlt: open graph and twitter card
coverWidth: 5442
coverHeight: 2710
time: 5
tags: Next.js, Google Analytics, App Router, SEO, Analytics Integration, Website Tracking
---
...
To activate tracking across all pages, import your `GoogleAnalytics.tsx` component in `app/layout.tsx` and pass your GA ID.
