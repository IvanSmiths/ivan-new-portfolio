...
<Sections>
  - [What is Open Graph](#what-is-open-graph) - [Add Open Graph and Twitter
  images](#the-new-approach) - [Add more metadata](#add-more-metadata) - [Add
  Open Graph and Twitter images to dynamic
  pages](#add-open-graph-and-twitter-images-to-dynamic-pages) - [Testing and
  validation with Vercel](#testing-and-validation-with-vercel)
</Sections>
...
<img
  ...
  height="932"
  src="/blog/add-open-graph-twitter-nextjs-app-router/open-graph-example.png"
  width="1280"
/>
...
<img
  ...
  height="680"
  src="/blog/add-open-graph-twitter-nextjs-app-router/open-graph-place-image.png"
  width="492"
  className="half"
/>
...
<img
  ...
  alt="open graph image placement"
  height="2880"
  src="/blog/add-open-graph-twitter-nextjs-app-router/open-graph-testing.png"
  width="1442"
/>
