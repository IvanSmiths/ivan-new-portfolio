...
<Sections>
    ...
    - [Testing and validation with Vercel](#testing-and-validation-with-vercel)
</Sections>
...
<img loading="lazy" alt="open graph image placement" height="680" src="/blog/add-open-graph-twitter-nextjs-app-router/open-graph-place-image.png" width="492" className="half"/>
