...
export const AnimatedTextWithImages = ({
  ...
  return (
    <h2 className="lg:leading-4xl md:leading-2xl leading-lg flex flex-wrap justify-center gap-x-2 gap-y-4 text-center text-4xl font-black uppercase md:text-6xl lg:text-8xl">
